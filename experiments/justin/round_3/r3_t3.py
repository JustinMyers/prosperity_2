...
class BasketTrader:
    def run(self, state: TradingState, product: str, data: dict):
        ...
        print(f"position: {gift_basket_position}, sum_of_basket_products: {sum_of_basket_products}, gift_basket_mid_price: {gift_basket_mid_price}, basket_ratio: {basket_ratio}, low_basket_ratio: {low_basket_ratio}, median_basket_ratio: {median_basket_ratio}, high_basket_ratio: {high_basket_ratio}")
        ...
        elif basket_ratio >= median_basket_ratio:
            orders["GIFT_BASKET"].append(Order("GIFT_BASKET", gift_basket_highest_buy_order_price + price_modifier, int(gift_basket_limit_width / 2) - gift_basket_position))
        else:
            orders["GIFT_BASKET"].append(Order("GIFT_BASKET", gift_basket_lowest_sell_order_price - price_modifier, int(-gift_basket_limit_width / 2) - gift_basket_position))

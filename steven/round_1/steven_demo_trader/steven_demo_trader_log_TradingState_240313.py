...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for product in state.order_depths:
            ...
            seventy_pct_of_price_diff = int(buy_sell_price_diff * 0.7)
        ...
        # traderData = "SAMPLE" 
        def toJSON(trading_state):
            return json.dumps(trading_state, default=lambda o: o.__dict__, sort_keys=True)
        traderData = toJSON(state)
